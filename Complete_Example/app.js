...
app.get('*', (req, res, next) => {
    ...
    /**
     * return next(): If the request path meets the criteria, the middleware calls next()
     * to pass control to the next middleware function in the stack, without sending a response.
     */
...
/**
 * The :room part is a route parameter, which means it can match any string
 * , and the value of this string can be accessed in the request handler.
 */
...
httpsServer.listen(5000, () => {
    ...
    console.log('localhost:5000/sfu/')
})
